...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/ic_burger_bar.png
  AssetGenImage get icBurgerBar =>
      const AssetGenImage('assets/images/ic_burger_bar.png');

  /// File path: assets/images/ic_fingerprint.png
  AssetGenImage get icFingerprint =>
      const AssetGenImage('assets/images/ic_fingerprint.png');
  ...
  List<AssetGenImage> get values =>
      [icBell, icBurgerBar, icFingerprint, icPlaceholder];
}
